...
$PHPMAILER_LANG['authenticate']         = 'SMTP 错误：登入失敗。';
$PHPMAILER_LANG['connect_host']         = 'SMTP 错误：無法連線到 SMTP 主機。';
$PHPMAILER_LANG['data_not_accepted']    = 'SMTP 错误：無法接受的資料。';
$PHPMAILER_LANG['empty_message']        = '郵件內容為空';
$PHPMAILER_LANG['encoding']             = '未知編碼: ';
$PHPMAILER_LANG['execute']              = '無法執行：';
$PHPMAILER_LANG['file_access']          = '無法存取檔案：';
$PHPMAILER_LANG['file_open']            = '檔案错误：無法開啟檔案：';
$PHPMAILER_LANG['from_failed']          = '發送地址错误：';
...
$PHPMAILER_LANG['recipients_failed']    = 'SMTP 错误：以下收件人地址错误：';
$PHPMAILER_LANG['signing']              = '電子簽章错误: ';
$PHPMAILER_LANG['smtp_connect_failed']  = 'SMTP 連線失敗';
$PHPMAILER_LANG['smtp_error']           = 'SMTP 伺服器错误: ';
