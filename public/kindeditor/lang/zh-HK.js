...
KindEditor.lang({
	...
	invalidRows : '欄數是必須輸入项目，只允許輸入大於0的數字。',
	invalidCols : '列數是必須輸入项目，只允許輸入大於0的數字。',
	invalidPadding : '內距必須是數字。',
	invalidSpacing : '間距必須是數字。',
	invalidJson : '伺服器發生故障。',
	uploadSuccess : '上傳成功。',
	cutError : '您的瀏覽器安全设置不允許使用剪下操作，請使用快捷鍵(Ctrl+X)完成。',
	copyError : '您的瀏覽器安全设置不允許使用剪下操作，請使用快捷鍵(Ctrl+C)完成。',
	pasteError : '您的瀏覽器安全设置不允許使用剪下操作，請使用快捷鍵(Ctrl+V)完成。',
	ajaxLoading : '加載中，請稍候 ...',
